...
import com.affinity.affinityteam.affinity.Adapters.UserAdapter;
import com.affinity.affinityteam.affinity.Models.Chatlist;
            ...
            public void onDataChange(@NonNull DataSnapshot dataSnapshot) {
                ...
                for(DataSnapshot snapshot : dataSnapshot.getChildren()){
                    ...
                    for(Chatlist chatlist : usersList){
                        if(fuser.getUid().equals(chatlist.getId())){
                            mUsers.add(user);
                        }
                    }
